...
export const mockProviders: Provider[] = [
  {
    ...
    kind: 'vmware',
    name: 'vmware-prod',
    url: 'https://vcenter.prod.example.com',
    status: 'ready',
    vmCount: 142,
  },
  {
    ...
    kind: 'vmware',
    name: 'vmware-dev',
    url: 'https://vcenter.dev.example.com',
    status: 'ready',
    vmCount: 38,
  },
  {
    id: 'prov-ovirt-dc1',
    kind: 'ovirt',
    name: 'rhv-datacenter-1',
    url: 'https://rhvm.dc1.example.com',
    status: 'error',
    vmCount: 64,
  },
  {
    id: 'prov-openstack-west',
    kind: 'openstack',
    name: 'openstack-west',
  ...
  },
  {
    id: 'prov-ocp-staging',
    kind: 'openshift',
    name: 'ocp-cluster-staging',
    url: 'https://api.ocp.staging.example.com:6443',
    status: 'unknown',
    vmCount: 0,
  },
];
...
export const mockNetworkMappings = {
  vmProd: { id: 'nm-001', name: 'prod-network-map', sourceNetwork: 'VM Network', targetNetwork: 'pod-network' },
  vmDev: { id: 'nm-002', name: 'dev-network-map', sourceNetwork: 'Dev Network', targetNetwork: 'pod-network' },
  ovirtMap: { id: 'nm-003', name: 'ovirt-network-map', sourceNetwork: 'ovirtmgmt', targetNetwork: 'pod-network' },
};

export const mockStorageMappings = {
  vmProd: { id: 'sm-001', name: 'prod-storage-map', sourceStorage: 'datastore-ssd', targetStorage: 'ocs-storagecluster-ceph-rbd' },
  vmDev: { id: 'sm-002', name: 'dev-storage-map', sourceStorage: 'datastore-hdd', targetStorage: 'ocs-storagecluster-ceph-rbd' },
  ovirtMap: { id: 'sm-003', name: 'ovirt-storage-map', sourceStorage: 'data', targetStorage: 'ocs-storagecluster-ceph-rbd' },
};

export const mockPlans: MigrationPlan[] = [
  {
    id: 'plan-001',
    name: 'web-tier-migration',
    description: 'Migrate production web servers to OpenShift cluster',
    source: 'prov-vmware-prod',
    target: 'prov-ocp-target',
    vms: ['vm-001', 'vm-002'],
    networkMap: mockNetworkMappings.vmProd,
    storageMap: mockStorageMappings.vmProd,
    status: 'succeeded',
    progress: 100,
  ...
  {
    id: 'plan-002',
    name: 'db-cluster-migration',
    description: 'Live migration of primary and replica database servers',
    source: 'prov-vmware-prod',
    target: 'prov-ocp-target',
    vms: ['vm-003', 'vm-004'],
    networkMap: mockNetworkMappings.vmProd,
  ...
  {
    id: 'plan-003',
    name: 'legacy-services-migration',
    description: 'Migrate legacy CentOS 7 services before EOL',
    source: 'prov-vmware-prod',
    target: 'prov-ocp-target',
    vms: ['vm-005', 'vm-006'],
    networkMap: mockNetworkMappings.vmProd,
  ...
  {
    id: 'plan-004',
    name: 'dev-k8s-workers',
    description: 'Move dev Kubernetes worker nodes to OCP staging',
    source: 'prov-vmware-dev',
    target: 'prov-ocp-staging',
    vms: ['vm-007', 'vm-008'],
    networkMap: mockNetworkMappings.vmDev,
    storageMap: mockStorageMappings.vmDev,
    status: 'ready',
    progress: 0,
  ...
  },
  {
    ...
    description: 'Relocate monitoring infrastructure from oVirt to OCP',
    source: 'prov-ovirt-dc1',
    target: 'prov-ocp-target',
    vms: ['vm-011', 'vm-012'],
    networkMap: mockNetworkMappings.ovirtMap,
    storageMap: mockStorageMappings.ovirtMap,
    status: 'draft',
    progress: 0,
  ...
  {
    id: 'plan-006',
    name: 'ci-runners-migration',
    description: 'Migrate CI/CD runners to reduce infrastructure costs',
    source: 'prov-vmware-dev',
    target: 'prov-ocp-staging',
    vms: ['vm-009', 'vm-010'],
    networkMap: mockNetworkMappings.vmDev,
