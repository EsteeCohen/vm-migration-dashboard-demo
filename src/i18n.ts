...
const strings: Record<Language, Record<string, string>> = {
  en: {
    ...
    'dashboard.statusBreakdown': 'Plan Status Breakdown',
    'dashboard.activityTitle': 'Migration Activity — Last 7 Days (GB)',
    'dashboard.totalPlansShort': 'total plans',
    'provider.added': 'Provider added',
    'provider.addFailed': 'Failed to add provider',
    'provider.updated': 'Provider updated',
    'provider.updateFailed': 'Failed to update provider',
    'provider.deleted': 'Provider deleted',
    'provider.deleteFailed': 'Failed to delete provider',
    'provider.deleteConfirm': 'Are you sure you want to delete',
    'action.edit': 'Edit',
  ...
  he: {
    ...
    'dashboard.activityTitle': 'פעילות הגירה - 7 ימים אחרונים (GB)',
    'dashboard.totalPlansShort': 'תוכניות',
    'provider.added': 'ספק נוסף',
    'provider.addFailed': 'הוספת ספק נכשלה',
    'provider.updated': 'ספק עודכן',
    'provider.updateFailed': 'עדכון ספק נכשל',
    'provider.deleted': 'ספק נמחק',
    'provider.deleteFailed': 'מחיקת ספק נכשלה',
    'provider.deleteConfirm': 'האם למחוק את',
    'action.edit': 'עריכה',
    'action.delete': 'מחיקה',
    'action.save': 'שמור',
    'action.confirmDelete': 'אישור מחיקה',
  },
};
